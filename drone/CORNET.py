...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="CORNET: An Open Source UAV Network Simulator")
	...
	#uav_thread = threading.Thread(target=uav.UAV, args=(format(i, "03d"), (5760 + i * 10),
        uav_thread = threading.Thread(target=uav.UAV, args=(format(i, "03d"), (14550), #(14550)(5760 + i * 10)
